				...
				<div class="content-left">
					...
					<div class="text list_1_of_2">
						  <div class="extra-wrap">
						  	...
						  	<span style="text-color:#000" class="data"><strong>В ролите :<?php echo $n['cast'];?></strong><br>
                                <div class="data">Дата на излизане :<?php echo $n['news_date'];?></div>
