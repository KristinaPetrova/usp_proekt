						...
						<h3><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								...
								<div class="desc span_3_of_2">
									<p class="p-link" style="font-size:15px">В ролите : <?php echo $movie['cast']; ?></p>
									<p class="p-link" style="font-size:15px">Дата на излизане : <?php echo date('d-M-Y',strtotime($movie['release_date'])); ?></p>
									<p style="font-size:15px"><?php echo $movie['desc']; ?></p>
									<a href="<?php echo $movie['video_url']; ?>" target="_blank" class="watch_but">Гледай трейлъра</a>
								</div>
								<div class="clear"></div>
							</div>
