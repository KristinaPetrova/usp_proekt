            ...
            <div class="content-left">
					...
					<div class="text list_1_of_2">
						  <div class="extra-wrap1">
                                        ...
                                        <span class="data">Дата на излизане:<?php echo $m['release_date'];?></span><br>
                                        В ролите:<Span class="data"><?php echo $m['cast'];?></span><br>
                                        Описание: <span" class="color2"><?php echo $m['desc'];?></span><br>
                                    </div>
					</div>
